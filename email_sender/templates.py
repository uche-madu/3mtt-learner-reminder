...
- Log in to your LMS here → https://app.3mtt.training/
...
<html>
  <body style="font-family: Arial, sans-serif; background-color: #DFFFD6; padding: 20px;">
    <div style="max-width: 600px; margin: auto; background-color: white; padding: 20px; border-radius: 8px;">
      ...
      <ul>
        <li>Log in to your LMS here → <a href="https://app.3mtt.training/">3MTT Dashboard</a></li>
      ...
      <p style="margin: 20px 0;">
        <a href="https://app.3mtt.training/" style="background-color: #A8E6A1; color: #000; padding: 10px 15px; text-decoration: none; border-radius: 5px;">Resume Learning Now</a>
      </p>
...
<html>
  <body style="font-family: Arial, sans-serif; background-color: #DFFFD6; padding: 20px;">
    <div style="max-width: 600px; margin: auto; background-color: white; padding: 20px; border-radius: 8px;">
      ...
      <p style="margin: 20px 0;">
        <a href="https://app.3mtt.training/" style="background-color: #A8E6A1; color: #000; padding: 10px 15px; text-decoration: none; border-radius: 5px;">Go Back to LMS and Improve Your Score</a>
      </p>
